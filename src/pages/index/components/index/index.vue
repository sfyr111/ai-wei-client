<template>
  <div class="index">
    <div class="app-content">
      <swiper auto loop height="5.173rem" dots-position="center" dots-class="custom-bottom">
...
import { wechatLogin, getPopularColumns, getClassify, getBanner } from 'pages/index/api'
...
export default {
  ...
  methods: {
    ...
    async _concurrent () {
      ...
      await Promise.all([this._getPopularColumns(), this._getClassify()])
    },
    whole () {
